// AboutUs.js - Fixed Hero Section with Proper Centering
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
        {/* Hero Section with Image - Fixed without space */}
        <div className="relative bg-gray-900 min-h-screen">
          <div className="absolute inset-0 overflow-hidden">
            <img 
              ...
              onError={(e) => {
                e.target.src = 'https://images.unsplash.com/photo-1556056504-5c7696c4c28d?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80';
              }}
            />
          </div>
            ...
            <div>
              ...
              <div className="mt-8 p-6 bg-gray-50 rounded-lg border border-gray-200">
                ...
                <p className="text-gray-600">
                  To become the leading global brand for football-inspired lifestyle apparel, 
                  celebrated for quality, innovation, and authentic connection to the beautiful game.
                </p>
              </div>
            </div>
              ...
              <div className="order-2 lg:order-1">
                <div className="bg-white rounded-2xl overflow-hidden shadow-xl">
                  <img 
                    ...
                    className="w-full h-96 object-cover"
                    onError={(e) => {
                      e.target.src = 'https://images.unsplash.com/photo-1558769132-cb25c5d1d1c1?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80';
                    }}
                  />
                </div>
              </div>
