        ...
        <div className="bg-gray-900 py-20">
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Have questions about FUTGEN? We're here to help and would love to hear from you.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-1">
              ...
              <p className="text-gray-600 mb-8">
                Whether you have questions about our products, need support with an order, or want to discuss
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-1">support@futgen.com</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-1">123 Football Avenue</p>
        ...
        <div className="bg-gray-50 py-20">
          <div className="max-w-4xl mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600">Quick answers to common questions about FUTGEN</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                <h3 className="text-lg font-bold text-gray-900 mb-3">What's your shipping policy?</h3>
                <p className="text-gray-600">
                  We offer free standard shipping on orders over $75. Most orders are processed within 1-2 business days and delivered within 3-7 business days.
                </p>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                ...
                <p className="text-gray-600">
                  We accept returns within 30 days of delivery. Items must be unworn, with original tags attached, and in original packaging.
                </p>
              </div>
