  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      const totalRevenue = orders
        ...
        .reduce((sum, order) => {
          const price = order.total?.toString().replace(/Rs\.|₹|,/g, '')?.replace(/\s+/g, '')?.trim() || '0';
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-yellow-700">
                  You have <span className="font-medium">{stats.pendingOrders}</span> orders pending confirmation
                </p>
              </div>
            </div>
          </div>
