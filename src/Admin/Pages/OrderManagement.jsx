        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-3 md:gap-4 mb-6">
          {statusOptions.map(status => (
            <button
              ...
              className={`bg-white p-3 md:p-4 rounded-lg shadow transition-all duration-200 hover:shadow-md ${
                selectedStatus === status.value ? 'ring-2 ring-red-500' : ''
              }`}
            >
              ...
              <p className={`text-xl md:text-2xl font-bold ${
                selectedStatus === status.value ? 'text-red-600' : 'text-gray-600'
              }`}>
