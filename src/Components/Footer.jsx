      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="mb-4">
              <h3 className="text-xl font-bold text-white mb-2">FUTGEN</h3>
              <p className="text-gray-400 text-sm">
                Football-inspired streetwear brand offering premium T-shirts, jackets, sweatshirts, and joggers for the modern fan.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-3">
              <li className="flex items-center">
                <svg className="w-4 h-4 text-red-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-400 text-sm">support@futgen.com</span>
              </li>
              {/* Add Business Hours */}
              <li className="flex items-center">
                <svg className="w-4 h-4 text-red-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-gray-400 text-sm">Mon-Sat: 10AM - 7PM</span>
              </li>
            </ul>
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">© 2025 FUTGEN. All rights reserved.</p>
            <div className="flex space-x-6 mt-2 md:mt-0">
              <a href="#" className="text-gray-400 hover:text-red-500 text-sm transition-colors duration-300">Privacy Policy</a>
              <a href="#" className="text-gray-400 hover:text-red-500 text-sm transition-colors duration-300">Terms of Service</a>
              <a href="#" className="text-gray-400 hover:text-red-500 text-sm transition-colors duration-300">Cookie Policy</a>
            </div>
          </div>
        </div>
      </div>
